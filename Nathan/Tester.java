import Nathan.Compound;
import Nathan.PeriodicTable;

public class Tester {
            public static void main(String[] args) {
            PeriodicTable table = new PeriodicTable("C:\\Users\\isaac\\OneDrive\\Documents\\GitHub\\Java\\Nathan\\elements.txt");
            ...
            System.out.println("Bond Type 1: " + compound1.getBondType());  // Expected: "ionic"
            ...
            System.out.println("Bond Type 2: " + compound2.getBondType());  // Expected: "covalent"
            ...
            System.out.println("Bond Type 3: " + compound3.getBondType());  // Expected: "covalent"
            ...
            System.out.println("Bond Type 4: " + compound4.getBondType());  // Expected: null
}
}